...
hl.window_rule({ name = "float-psysonic",     match = { class = "^psysonic-bin$" },float = true, pin = true, center = true, size = "75% 85%" })
hl.window_rule({ name = "float-vit",          match = { class = "^vit$" },         float = true, size = "65% 65%" })
...
hl.window_rule({
    name      = "special-psysonic",
    match     = { class = "^Psysonic-bin$" },
    float     = true,
    pin       = true,
    center    = true,
    size      = "75% 85%",
    workspace = "special:psysonic silent",
})
